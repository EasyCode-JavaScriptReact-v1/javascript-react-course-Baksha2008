...
function reverseEachWord(str) {
  ...
  let reversStr = arrToStr.map(function(elem) {
...
//  * */
  ...
  function reverseEachWord(str, boolean){
    let arrToStr = str.split(' ');
    let reversToStr = arrToStr.map(function(elem){
      return elem.split('').reverse().join('')
    })
    if(boolean === true){
      return reversToStr.reverse().join(' ');
    }
    return reversToStr.join(' ');
  };
